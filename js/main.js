;(function () {
	...
	// Set the date we're counting down to
		var countDownDate = new Date("Jan 08, 2021 11:00:00").getTime();
		...
		// Display the result in an element with id="demo"
		document.getElementById("days").innerHTML = days +" <small>ngày</small>";
		document.getElementById("hours").innerHTML = hours + " <small>giờ</small> ";
		document.getElementById("minutes").innerHTML = minutes + " <small>phút</small> ";
		document.getElementById("seconds").innerHTML = seconds + " <small>giây</small> ";
